...
Nicht geprueft ist der Fall mit laufender Bluetooth-Integration. Die
...
def test_die_anmeldung_haelt_den_hub_vertrag_ein(registrierung):
    ...
    Der Vertrag MIT Inhalt wird in tests_ha/test_konformitaet_mit_inhalt.py geprueft.
    """
...
async def test_ohne_bluetooth_liefert_data_eine_leere_ebene(registrierung):
    """Kein Bluetooth im Haus heisst leer -- nicht kaputt.
